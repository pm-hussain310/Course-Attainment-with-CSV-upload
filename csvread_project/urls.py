...
urlpatterns = [
    ...
    path('load_marks_with_csv', views.load_marks_with_csv, name='load_marks_with_csv'),
    ...
    path('interna_question', views.interna_question, name='interna_question'),
    path('edit_interna_question', views.edit_interna_question, name='edit_interna_question'),
    path('external_question', views.external_question, name='external_question'),
    path('edit_external_question', views.edit_external_question, name='edit_external_question'),
